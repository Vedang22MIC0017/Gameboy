    ...
    <div className="relative h-dvh w-screen overflow-x-hidden">
        ...
        h-dvh w-screen overflow-hidden rounded-lg bg-blue-75" >
            <div>
                ...
                absolute-center absolute z-50 size-64 cursor-pointer
            ...
            <div className="absolute left-0 top-0 z-40 size-full">
                <div className="mt-24 px-5 sm:px-10">
                    <h1 className="special-font hero-heading text-blue-100">redenfi<b>n</b>e</h1>
                    <p className="mb-5 max-w-64 font-robert-regular text-blue-100">Enter the Metagame Layer <br /> Unleash the Gamer in You  </p>
